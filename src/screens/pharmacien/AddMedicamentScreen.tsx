...
export default function AddMedicamentScreen({ navigation }: any) {
    const { addMedicament, medicaments, isLoading } = useMedicamentStore();
    const [formData, setFormData] = useState({
        nom: '',
        dosage: 500, // Slider value
        forme: 'Comprimé',
        quantiteStock: 0,
        fabricant: 'Sanofi',
    });
    ...
    const validateForm = (): boolean => {
        ...
        const duplicateName = medicaments.find(
            m => m.nom.toLowerCase() === formData.nom.trim().toLowerCase()
        );
        if (duplicateName) {
        ...
        >
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <Animated.View entering={FadeInDown.delay(50)} style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Nouveau Médicament</Text>
                    <Text style={styles.headerSubtitle}>Ajoutez un médicament à votre inventaire</Text>
                </Animated.View>
